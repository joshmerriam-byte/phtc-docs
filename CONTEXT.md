...
- Purpose clauses (constitution 3.2): **placed in v1.10** as a new clause 3.2(f), since no existing clause overclaimed and there was nothing to replace. The clause as supplied in the change list was truncated mid-sentence; the wording was completed to match the narrative and clause 5.1 and carries a `[Flag for Josh]` marker. **Confirm or replace that wording before the constitution circulates.**
